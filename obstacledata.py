...
class Stage1Obstacle:
    def __init__(self):
        ...
        self.block2s = [object.UneasyBlock(Pos1.blockPos200[i], 250) for i in range(len(Pos1.blockPos200))]
        self.block3s = [object.UneasyBlock(Pos1.blockPos300[i], 400) for i in range(len(Pos1.blockPos300))]
        ...
        self.randombox = [object.RandomBox(Pos1.randomBoxPos[i], 250) for i in range(len(Pos1.randomBoxPos))]
...
class Stage2Obstacle:
    def __init__(self):
        ...
        self.block2s = [object.UneasyBlock(Pos2.blockPos200[i], 250) for i in range(len(Pos2.blockPos200))]
        self.block3s = [object.UneasyBlock(Pos2.blockPos350[i], 400) for i in range(len(Pos2.blockPos350))]
        ...
        self.randombox = [object.RandomBox(Pos2.randomBoxPos[i], 250) for i in range(len(Pos2.randomBoxPos))]
