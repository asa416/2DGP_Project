...
def enter():
    ...
    game_world.add_objects(server.obstacles.block2s, 1)
    game_world.add_objects(server.obstacles.block3s, 1)
    # game_world.add_objects(server.obstacles.obstacleBlock, 1)
    game_world.add_objects(server.obstacles.pipes, 1)
    game_world.add_objects(server.obstacles.coins, 1)
    game_world.add_objects(server.obstacles.randombox, 1)
    game_world.add_object(server.obstacles.plag, 1)
